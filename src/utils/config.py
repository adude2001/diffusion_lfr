...
def add_base_args(parser):
    ...
    parser.add_argument('--model_family', type=str, default='cvae', choices=['cvae', 'diffusion'],
                        help='Model family to use.')
    parser.add_argument('--diff_timesteps', type=int, default=100,
                        help='Number of diffusion timesteps for training/noising process.')
    parser.add_argument('--diff_sampling_timesteps', type=int, default=20,
                        help='Number of diffusion timesteps for sampling/denoising process.')
    parser.add_argument('--diff_objective', type=str, default='pred_v', choices=['pred_noise', 'pred_x0', 'pred_v'],
                        help='Diffusion training objective.')
    parser.add_argument('--cfg_drop_prob', type=float, default=0.1,
                        help='Classifier-free guidance conditioning drop probability.')
